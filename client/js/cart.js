...
async function updateQuantity(cartItemId, newQuantity) {
  ...
  try {
    const response = await fetch(`https://full-stack-fooddeliveringproject.onrender.com/api/cart/update/${cartItemId}`, {
      method: "PUT",
      headers: {
...
async function removeItem(cartItemId) {
  try {
    const response = await fetch(`https://full-stack-fooddeliveringproject.onrender.com/api/cart/remove/${cartItemId}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`
      }
