...
productForm.addEventListener("submit", async function (e) {
  ...
  try {
    ...
    if (productId) {
      response = await fetch(`https://full-stack-fooddeliveringproject.onrender.com/api/products/update/${productId}`, {
        method: "PUT",
        headers: {
      ...
      response = await fetch("https://full-stack-fooddeliveringproject.onrender.com/api/products/add", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
...
async function deleteProduct(productId) {
  ...
  try {
    const response = await fetch(`https://full-stack-fooddeliveringproject.onrender.com/api/products/delete/${productId}`, {
      method: "DELETE",
      headers: {
        "Authorization": `Bearer ${token}`
      }
